 ...
 * @see <a href=
 *      "http://en.wikipedia.org/wiki/Metaphone">http://en.wikipedia.org/wiki/Metaphone</a>
 *
 */
public class DoubleMetaphone implements StringEncoder {
	...
	private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = { "ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN",
			"IE", "EI", "ER" };
	...
	/**
	 * Encode the value using DoubleMetaphone. It will only work if <code>obj</code>
	 * is a <code>String</code> (like <code>Metaphone</code>).
	 *
	 * @param obj
	...
	/**
	 * Check if the Double Metaphone values of two <code>String</code> values are
	 * equal.
	 *
	 * @param value1
	 *            The left-hand side of the encoded {@link String#equals(Object)}.
	 * @param value2
	 *            The right-hand side of the encoded {@link String#equals(Object)}.
	...
	/**
	 * Check if the Double Metaphone values of two <code>String</code> values are
	 * equal, optionally using the alternate value.
	 *
	 * @param value1
	 *            The left-hand side of the encoded {@link String#equals(Object)}.
	 * @param value2
	 *            The right-hand side of the encoded {@link String#equals(Object)}.
	 * @param alternate
	 *            use the alternate value if <code>true</code>.
	 * @return <code>true</code> if the encoded <code>String</code>s are equal;
	 *         <code>false</code> otherwise.
	 */
	...
	private boolean conditionL0(final String value, final int index) {
		if (index == value.length() - 3 && contains(value, index - 1, 4, "ILLO", "ILLA", "ALLE")) {
			return true;
				...
				|| contains(value, value.length() - 1, 1, "A", "O")) && contains(value, index - 1, 4, "ALLE")) {
			return true;
		} else {
			return false;
		}
	...
	/**
	 * Determines whether or not a value is of slavo-germanic origin. A value is of
	 * slavo-germanic origin if it contians any of 'W', 'K', 'CZ', or 'WITZ'.
	 */
	private boolean isSlavoGermanic(final String value) {
		return value.indexOf('W') > -1 || value.indexOf('K') > -1 || value.indexOf("CZ") > -1
	 ...
	 * return <code>true</code> if the value starts with any of 'GN', 'KN', 'PN',
	 * 'WR' or 'PS'.
	 */
