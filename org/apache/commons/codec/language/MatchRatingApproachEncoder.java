...
public class MatchRatingApproachEncoder implements StringEncoder {
	 ...
	 */
	private static final int ONE = 1, TWO = 2, THREE = 3, FOUR = 4, FIVE = 5, SIX = 6, SEVEN = 7, ELEVEN = 11,
			TWELVE = 12;
	...
	/**
	 * Unicode characters corresponding to various accented letters. For example:
	 * \u00DA is U acute etc...
	 */
	...
	private static final String[] DOUBLE_CONSONANT = new String[] { "BB", "CC", "DD", "FF", "GG", "HH", "JJ", "KK",
			"LL", "MM", "NN", "PP", "QQ", "RR", "SS", "TT", "VV", "WW", "XX", "YY", "ZZ" };

	/**
	 * Cleans up a name: 1. Upper-cases everything 2. Removes some common
	 * punctuation 3. Removes accents 4. Removes any spaces.
	 *
	 * <h2>API Usage</h2>
	 * <p>
	...
	/**
	 * Encodes an Object using the Match Rating Approach algorithm. Method is here
	 * to satisfy the requirements of the Encoder interface Throws an
	 * EncoderException if input object is not of type java.lang.String.
	 *
	 * @param pObject
	 *            Object to encode
	...
	/**
	 * Gets the first and last 3 letters of a name (if &gt; 6 characters) Else just
	 * returns the name.
	 *
	 * <h2>API Usage</h2>
	 * <p>
	...
	/**
	 * Obtains the min rating of the length sum of the 2 names. In essence the
	 * larger the sum length the smaller the min rating. Values strictly from
	 * documentation.
	 *
	 * <h2>API Usage</h2>
	 * <p>
	...
	/**
	 * Determines if two names are homophonous via Match Rating Approach (MRA)
	 * algorithm. It should be noted that the strings are cleaned in the same way as
	 * {@link #encode(String)}.
	 *
	 * @param name1
	 ...
	 * identical letters in same positions. Then subtracts the longer string that
	 * remains from 6 and returns this.
	 *
	 * <h2>API Usage</h2>
	 * <p>
	 * Consider this method private, it is package protected for unit testing only.
	...
	/**
	 * Removes accented letters and replaces with non-accented ascii equivalent Case
	 * is preserved.
