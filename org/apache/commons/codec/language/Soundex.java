 ...
 *
 * This class is thread-safe. Although not strictly immutable, the
 * {@link #maxLength} field is not actually used.
 *
 */
public class Soundex implements StringEncoder {

	/**
	 * The marker character used to indicate a silent (ignored) character. These are
	 * ignored except when they appear as the first character.
	 * <p>
	 * Note: the {@link #US_ENGLISH_MAPPING_STRING} does not use this mechanism
	 * because changing it might break existing code. Mappings that don't contain a
	 ...
	 * <code>0</code> for a letter position means do not encode, but treat as a
	 * separator when it occurs between consonants with the same code.
	 * <p>
	 * (This constant is provided as both an implementation convenience and to allow
	 * Javadoc to pick up the value for the constant values page.)
	 * <p>
	 * <b>Note that letters H and W are treated specially.</b> They are ignored
	 * (after the first letter) and don't act as separators between consonants with
	 * the same code.
	 * 
	...
	/**
	 * This is a default mapping of the 26 letters used in US English. A value of
	 * <code>0</code> for a letter position means do not encode.
	 *
	...
	/**
	 * An instance of Soundex using the US_ENGLISH_MAPPING mapping. This treats H
	 * and W as silent letters. Apart from when they appear as the first letter,
	 * they are ignored. They don't act as separators between duplicate codes.
	 *
	 * @see #US_ENGLISH_MAPPING
	...
	/**
	 * An instance of Soundex using the Simplified Soundex mapping, as described
	 * here: http://west-penwith.org.uk/misc/soundex.htm
	 * <p>
	 * This treats H and W the same as vowels (AEIOUY). Such letters aren't encoded
	 * (after the first), but they do act as separators when dropping duplicate
	 ...
	 * <p>
	 * This treats vowels (AEIOUY), H and W as silent letters. Such letters are
	 * ignored (after the first) and do not act as separators when dropping
	 * duplicate codes.
	 * <p>
	...
	/**
	 * The maximum length of a Soundex code - Soundex codes are only four characters
	 * by definition.
	 *
	 ...
	 * <p>
	 * In versions of the code prior to 1.11, the code always treated H and W as
	 * silent (ignored) letters. If this field is false, H and W are no longer
	 * special-cased.
	 */
	...
	/**
	 * Creates a soundex instance using the given mapping. This constructor can be
	 * used to provide an internationalized mapping for a non-Western character set.
	 *
	 * Every letter of the alphabet is "mapped" to a numerical value. This char
	 * array holds the values to which each letter is mapped. This implementation
	 * contains a default map for US_ENGLISH
	 * <p>
	 * If the mapping contains an instance of {@link #SILENT_MARKER} then H and W
	...
	/**
	 * Creates a refined soundex instance using a custom mapping. This constructor
	 * can be used to customize the mapping, and/or possibly provide an
	 ...
	 *
	 * @param mapping
	 *            Mapping string to use when finding the corresponding code for a
	 *            given character
	 * @since 1.4
	 */
	...
	/**
	 * Encodes the Strings and returns the number of characters in the two encoded
	 * Strings that are the same. This return value ranges from 0 through 4: 0
	 ...
	 * @param s2
	 *            A String that will be encoded and compared.
	 * @return The number of characters in the two encoded Strings that are the same
	 *         from 0 to 4.
	 *
	...
	/**
	 * Encodes an Object using the soundex algorithm. This method is provided in
