...
final class SoundexUtils {
	...
	/**
	 * Cleans up the input string before Soundex processing by only returning upper
	 * case letters.
	 *
	 * @param str
	 *            The String to clean.
	 ...
	 * @param s2
	 *            A String that will be encoded and compared.
	 * @return The number of characters in the two Soundex encoded Strings that are
	 *         the same.
	 *
	...
	/**
	 * Returns the number of characters in the two Soundex encoded Strings that are
	 * the same.
	 * <ul>
	 * <li>For Soundex, this return value ranges from 0 through 4: 0 indicates
	 * little or no similarity, and 4 indicates strong similarity or identical
