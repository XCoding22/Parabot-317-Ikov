 ...
 * while the form with prefix encodes to " <code>dortlaj|dortlej</code>". Thus,
 * the full, combined encoding is
 ...
 * </p>
 * 
 * @see <a href="http://stevemorse.org/phonetics/bmpm.htm">Beider-Morse Phonetic
 *      Matching</a>
...
public class BeiderMorseEncoder implements StringEncoder {
	 ...
	 *
	 * @return true if multiple encodings are concatenated, false if just the first
	 *         one is returned
	 */
	 ...
	 *
	 * @param concat
	 *            true if multiple encodings are to be combined with a '|', false if
	 *            just the first one is to be considered
	 */
	...
	/**
	 * Sets the type of name. Use {@link NameType#GENERIC} unless you specifically
	 * want phonetic encodings optimized for Ashkenazi or Sephardic Jewish family
	 * names.
	 *
	 * @param nameType
	 *            the NameType in use
	...
	/**
	 * Sets the rule type to apply. This will widen or narrow the range of phonetic
	 * encodings considered.
	 *
	 * @param ruleType
	 *            {@link RuleType#APPROX} or {@link RuleType#EXACT} for approximate
	 *            or exact phonetic matches
	 */
	...
	public void setMaxPhonemes(final int maxPhonemes) {
		this.engine = new PhoneticEngine(this.engine.getNameType(), this.engine.getRuleType(), this.engine.isConcat(),
				maxPhonemes);
	}
