 ...
 * <p>
 * This class encapsulates rules used to guess the possible languages that a
 * word originates from. This is done by reference to a whole series of rules
 * distributed in resource files.
 * <p>
 * Instances of this class are typically managed through the static factory
 * method instance(). Unless you are developing your own language guessing
 * rules, you will not need to interact with this class directly.
 * <p>
 * This class is intended to be immutable and thread-safe.
 * <p>
 * <b>Lang resources</b>
 * <p>
 * Language guessing rules are typically loaded from resource files. These are
 * UTF-8 encoded text files. They are systematically named following the
 * pattern:
 * <blockquote>org/apache/commons/codec/language/bm/lang.txt</blockquote> The
 * format of these resources is the following:
 * <ul>
 * <li><b>Rules:</b> whitespace separated strings. There should be 3 columns to
 * each row, and these will be interpreted as:
 * <ol>
 * <li>pattern: a regular expression.</li>
 * <li>languages: a '+'-separated list of languages.</li>
 * <li>acceptOnMatch: 'true' or 'false' indicating if a match rules in or rules
 * out the language.</li>
 * </ol>
 * </li>
...
public class Lang {
	...
	// exposes the LANGUAGE_RULES_RN resource as a Lang instance. The second part is
	// the Lang instance methods that
	// encapsulate a particular language-guessing rule table and the language
	// guessing itself.
	//
	// It may make sense in the future to expose the private constructor to allow
	// power users to build custom language-
	// guessing rules, perhaps by marking it protected and allowing sub-classing.
	// However, the vast majority of users
	// should be strongly encouraged to use the static factory <code>instance</code>
	 ...
	 * {@link #instance(NameType)} method. You will only need to call this yourself
	 * if you are developing custom language mapping rules.
	 *
	 ...
	 * @param text
	 *            the word
	 * @return the language that the word originates from or {@link Languages#ANY}
	 ...
	 * @param input
	 *            the word
	 * @return a Set of Strings of language names that are potential matches for the
	 *         input word
	 */
