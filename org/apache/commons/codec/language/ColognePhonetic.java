 ...
 * <p>
 * Implements the
 * <a href="http://de.wikipedia.org/wiki/K%C3%B6lner_Phonetik">K&ouml;lner
 ...
 *
 * <li>
 * <h3>Step 1:</h3> After preprocessing (conversion to upper case, transcription
 * of <a href="http://en.wikipedia.org/wiki/Germanic_umlaut">germanic
 * umlauts</a>, removal of non alphabetical characters) the letters of the
 * supplied text are replaced by their phonetic code according to the following
 * table.
 * <table border="1">
 * <caption style="caption-side: bottom"><small><i>(Source: <a href=
 * "http://de.wikipedia.org/wiki/K%C3%B6lner_Phonetik#Buchstabencodes">Wikipedia
 * (de): K&ouml;lner Phonetik -- Buchstabencodes</a>)</i></small></caption>
 * <tbody>
 * <tr>
 * <th>Letter</th>
 * <th>Context</th>
 ...
 *
 * <li>
 * <h3>Step 2:</h3> Collapse of all multiple consecutive code digits.
 * <h4>Example:</h4>
 * <code>"6005507500206880022" =&gt; "6050750206802"</code></li>
 *
 * <li>
 * <h3>Step 3:</h3> Removal of all codes "0" except at the beginning. This means
 * that two or more identical consecutive digits can occur if they occur after
 * removing the "0" digits.
 *
 * <h4>Example:</h4> <code>"6050750206802" =&gt; "65752682"</code></li>
 *
 * </ul>
 *
 * <p>
...
public class ColognePhonetic implements StringEncoder {
	...
	/**
	 * This class is not thread-safe; the field {@link #length} is mutable. However,
	 * it is not shared between threads, as it is constructed on demand by the
	...
	/**
	 * Maps some Germanic characters to plain for internal processing. The following
	...
	public String colognePhonetic(String text) {
		...
		while (input.length() > 0) {
			...
			// OK to ignore H here because it only affects nextChar which has already been
			// set up
