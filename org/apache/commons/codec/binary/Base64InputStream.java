...
public class Base64InputStream extends BaseNCodecInputStream {
	...
	/**
	 * Creates a Base64InputStream such that all data read is Base64-decoded from
	...
	/**
	 * Creates a Base64InputStream such that all data read is either Base64-encoded
	 * or Base64-decoded from the original provided InputStream.
	 *
	 * @param in
	 *            InputStream to wrap.
	 * @param doEncode
