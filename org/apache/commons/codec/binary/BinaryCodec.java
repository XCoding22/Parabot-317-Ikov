...
public class BinaryCodec implements BinaryDecoder, BinaryEncoder {
	 ...
	 * @param array
	 *            the source array
	 * @return <code>true</code> if the given array is <code>null</code> or empty
	 *         (size 0.)
	 */
	...
	/**
	 * Converts an array of raw binary data into an array of ASCII 0 and 1 character
	 * bytes - each byte is a truncated char.
	 *
	 * @param raw
	 *            the raw binary data to convert
