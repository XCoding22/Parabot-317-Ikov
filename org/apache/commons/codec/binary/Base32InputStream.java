 ...
 * default behaviour of the Base32OutputStream is to ENCODE, but this behaviour
...
public class Base32InputStream extends BaseNCodecInputStream {
	...
	/**
	 * Creates a Base32InputStream such that all data read is Base32-decoded from
	 * the original provided InputStream.
	 *
	 * @param in
	 *            InputStream to wrap.
	 */
	...
	/**
	 * Creates a Base32InputStream such that all data read is either Base32-encoded
	 * or Base32-decoded from the original provided InputStream.
	 *
	 * @param in
	 *            InputStream to wrap.
	 * @param doEncode
	 *            true if we should encode all data read from us, false if we should
	 *            decode.
	 */
	 ...
	 *            lineLength characters (rounded down to nearest multiple of 4). If
	 *            lineLength &lt;= 0, the encoded data is not divided into lines. If
	 *            doEncode is false, lineLength is ignored.
	 * @param lineSeparator
	 *            If doEncode is true, each line of encoded data will be terminated
	 *            with this byte sequence (e.g. \r\n). If lineLength &lt;= 0, the
	 *            lineSeparator is not used. If doEncode is false lineSeparator is
	 *            ignored.
	 */
