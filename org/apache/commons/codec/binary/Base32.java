 ...
 * still essentially end up being multiples of 8 in the encoded data.
...
public class Base32 extends BaseNCodec {
	 ...
	 * the "Base32 Alphabet" (as specified in Table 3 of RFC 4648) into their 5-bit
	 * positive integer equivalents. Characters that are not in the Base32 alphabet
	...
	/**
	 * This array is a lookup table that translates Unicode characters drawn from
	 * the "Base32 Hex Alphabet" (as specified in Table 4 of RFC 4648) into their
	 * 5-bit positive integer equivalents. Characters that are not in the Base32 Hex
	...
	/**
	 * This array is a lookup table that translates 5-bit positive integer index
	 * values into their "Base32 Hex Alphabet" equivalents as specified in Table 4
	 * of RFC 4648.
	 */
	 ...
	 *            (rounded down to nearest multiple of 8). If lineLength &lt;= 0,
	 *            then the output will not be divided into lines (chunks). Ignored
	 *            when decoding.
	 */
	 ...
	 *
	 *            Output is written to {@link Context#buffer} as 8-bit octets, using
	 ...
	 * set to "-1" to alert encoder that EOF has been reached, so flush last
	...
	/**
	 * <p>
	 * Validates whether the character is possible in the context of the set of
	 * possible base 32 values.
	 * </p>
	 * 
	 * @param numBits
	 *            number of least significant bits to check
	 * @param context
	 *            the context to be used
	 * 
	 * @throws IllegalArgumentException
