 ...
 * <p>
 * To write the EOF marker without closing the stream, call {@link #eof()} or
 * use an <a href="https://commons.apache.org/proper/commons-io/">Apache Commons
 * IO</a> <a href=
...
public class BaseNCodecOutputStream extends FilterOutputStream {
	 ...
	 * out to the stream. If propagate is true, the wrapped stream will also be
	 * flushed.
	 *
	 * @param propagate
	 *            boolean flag to indicate whether the wrapped OutputStream should
	 *            also be flushed.
	 * @throws IOException
	 *             if an I/O error occurs.
	 */
