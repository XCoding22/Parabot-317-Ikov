 ...
 * default behaviour of the Base32InputStream is to DECODE. But this behaviour
 ...
 * </p>
 * <p>
 * <b>Note:</b> It is mandatory to close the stream after the last byte has been
 * written to it, otherwise the final padding will be omitted and the resulting
 * data will be incomplete/inconsistent.
 * </p>
 *
...
public class Base32OutputStream extends BaseNCodecOutputStream {
	...
	/**
	 * Creates a Base32OutputStream such that all data written is Base32-encoded to
