...
public class Digest {
	...
	/**
	 * Runs the digest algorithm in {@code args[0]} on the file in {@code args[1]}.
	 * If there is no {@code args[1]}, use standard input.
	 *
	 * <p>
	 * The algorithm can also be {@code ALL} or {@code *} to output one line for
	 * each known algorithm.
	 * </p>
	 *
	 * @param args
