 ...
 * {@link #encodeBlanks} is mutable {@link #setEncodeBlanks(boolean)} but is not
 ...
 * threads, and must not invoke {@link #setEncodeBlanks(boolean)} after initial
 * setup.
 *
...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
	...
	/**
	 * Decodes a quoted-printable string into its original form. Escaped characters
	 ...
	 * @throws DecoderException
	 *             Thrown if the argument is not a <code>String</code>. Thrown if a
