 ...
 * Note:
 * <p>
 * Depending on the selected {@code strict} parameter, this class will implement
 * a different set of rules of the quoted-printable spec:
 * <ul>
...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
	...
	/**
	 * Constructor which allows for the selection of a default Charset and strict
	 * mode.
	 *
	 * @param charset
	 *            the default string Charset to use.
	...
	/**
	 * Return the byte at position <code>index</code> of the byte array and make
	 * sure it is unsigned.
	 *
	 * @param index
	 ...
	 * (rule #1 and rule #2) as defined in RFC 1521 and is suitable for encoding
	 ...
	 * Unsafe characters are escaped.
	 * <p>
	 * Depending on the selection of the {@code strict} parameter, this function
	 * either implements the full ruleset or only a subset of quoted-printable
	 * encoding specification (rule #1 and rule #2) as defined in RFC 1521 and is
	 ...
	 *            array of bytes to be encoded
	 * @param strict
	 *            if {@code true} the full ruleset is used, otherwise only rule #1
	 *            and rule #2
	 * @return array of bytes containing quoted-printable data
	 * @since 1.10
	 */
	 ...
	 * <p>
	 * This function fully implements the quoted-printable encoding specification
	 * (rule #1 through rule #5) as defined in RFC 1521.
	 *
	 * @param bytes
	...
	/**
	 * Decodes a quoted-printable string into its original form using the specified
	...
	/**
	 * Encodes an object into its quoted-printable safe form. Unsafe characters are
	 * escaped.
	 *
	 * @param obj
	 ...
	 *             of this type or if encoding is unsuccessful
	 */
	@Override
	 ...
	 *             <code>byte[]</code>. Thrown if a failure condition is encountered
