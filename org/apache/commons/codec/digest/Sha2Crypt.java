...
public class Sha2Crypt {
	 ...
	 * calling {@link #sha256Crypt(byte[], String)}.
	 * </p>
	 *
	 * @param keyBytes
	 *            plaintext to hash
	 ...
	 *            {@link SecureRandom}. If one does not want to use
	 *            {@link SecureRandom}, you can pass your own {@link Random} in
	 *            {@link #sha256Crypt(byte[], String, Random)}.
	 ...
	 * numbered comments are from the algorithm description, the short C-style ones
	...
	private static String sha2Crypt(final byte[] keyBytes, final String salt, final String saltPrefix,
		...
		// inconsistency.
		/*
		 * The last part is the salt string. This must be at most 16 characters and it
		 * ends at the first `$' character (for compatibility with existing
		 * implementations).
		 */
		 ...
		 * will be added to the first context.
		 */
		...
		/*
		 * Take the binary representation of the length of the key and for every 1 add
	 ...
	 * A salt is generated for you using {@link ThreadLocalRandom}; for more secure
	 * salts consider using {@link SecureRandom} to generate your own salts and
	 * calling {@link #sha512Crypt(byte[], String)}.
	 * </p>
	 *
	 * @param keyBytes
	 *            plaintext to hash
	 ...
	 *            real salt value without prefix or "rounds=". The salt may be null,
	 *            in which case a salt is generated for you using
	 *            {@link SecureRandom}; if you want to use a {@link Random} object
	 *            other than {@link SecureRandom} then we suggest you provide it
	 *            using {@link #sha512Crypt(byte[], String, Random)}.
	 * @return complete hash value including salt
	 * @throws IllegalArgumentException
	 *             if the salt does not match the allowed pattern
	 * @throws IllegalArgumentException
