...
public class DigestUtils {
	 ...
	 * a default if there is a problem getting the algorithm.
	 *
	 * @param algorithm
	 *            the name of the algorithm requested. See <a href=
	 *            "http://docs.oracle.com/javase/6/docs/technotes/guides/security/crypto/CryptoSpec.html#AppA"
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because MD2 is a built-in algorithm
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because MD5 is a built-in algorithm
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because SHA-1 is a built-in algorithm
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because SHA-256 is a built-in algorithm
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             not happen on Oracle Java 9 andgreater.
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             not happen on Oracle Java 9 and greater.
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because SHA-384 is a built-in algorithm
	 ...
	 * @throws IllegalArgumentException
	 *             when a {@link NoSuchAlgorithmException} is caught, which should
	 *             never happen because SHA-512 is a built-in algorithm
	 ...
	 * using UTF-8).
	 * <p>
	 * To update the digest using a different charset for the conversion, convert
	 * the String to a byte array using
	 ...
	 *            the {@link MessageDigest} to update
	 * @param valueToDigest
	 *            the value to update the {@link MessageDigest} with; converted to
	 *            bytes using {@link StringUtils#getBytesUtf8(String)}
	 * @return the updated {@link MessageDigest}
	 * @since 1.7
	 */
