...
public class Md5Crypt {
	 ...
	 * <p>
	 * A salt is generated for you using {@link SecureRandom}; your own
	 * {@link Random} in {@link #apr1Crypt(byte[], Random)}.
	 * </p>
	 *
	 * @param keyBytes
	 ...
	 *            Consider using {@link SecureRandom} or {@link ThreadLocalRandom}.
	 * @return the hash value
	 * @throws IllegalArgumentException
	 *             when a {@link java.security.NoSuchAlgorithmException} is caught.
	 * *
	 ...
	 *            generated for you using {@link ThreadLocalRandom}; for more secure
	 *            salts consider using {@link SecureRandom} to generate your own
	 *            salts.
	 * @return the hash value
	 * @throws IllegalArgumentException
	 ...
	 * calling {@link #apr1Crypt(byte[], String)}.
	 * </p>
	 *
	 * @param keyBytes
	 *            plaintext string to hash.
	 ...
	 *            end. The salt may be null, in which case a salt is generated for
	 *            you using {@link ThreadLocalRandom}; for more secure salts
	 ...
	 * A salt is generated for you using {@link ThreadLocalRandom}; for more secure
	 * salts consider using {@link SecureRandom} to generate your own salts and
	 * calling {@link #md5Crypt(byte[], String)}.
	 * </p>
	 * 
	 * @param keyBytes
	 *            plaintext string to hash.
	 ...
	 * <p>
	 * See {@link Crypt#crypt(String, String)} for details. We use
	 * {@link SecureRandom} for seed generation by default.
	 * </p>
	 *
	 * @param keyBytes
	 *            plaintext string to hash.
	 ...
	 * <p>
	 * See {@link Crypt#crypt(String, String)} or {@link #apr1Crypt(String, String)}
	 * for details. We use {@link SecureRandom by default}.
	 * </p>
	 *
	 * @param keyBytes
	 *            plaintext string to hash.
	...
	public static String md5Crypt(final byte[] keyBytes, final String salt, final String prefix, final Random random) {
		...
		/*
		 * and now, just to make sure things don't run too fast On a 60 Mhz Pentium this
		 * takes 34 msec, so you would need 30 seconds to build a 1000 entry
		 * dictionary...
		 */
		...
		// int buflen = MD5_PREFIX.length() - 1 + salt_string.length() + 1 + BLOCKSIZE +
		// 1;
