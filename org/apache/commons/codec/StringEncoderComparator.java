...
/**
 * Compares Strings using a {@link StringEncoder}. This comparator is used to
 * sort Strings by an encoding scheme such as Soundex, Metaphone, etc. This
 * class can come in handy if one need to sort Strings by an encoded form of a
 * name such as Soundex.
 *
 * <p>
...
// TODO ought to implement Comparator<String> but that's not possible whilst
...
public class StringEncoderComparator implements Comparator {
	 ...
	 *
	 * @deprecated Creating an instance without a {@link StringEncoder} leads to a
	 *             {@link NullPointerException}. Will be removed in 2.0.
	 */
	@Deprecated
	...
	/**
	 * Compares two strings based not on the strings themselves, but on an encoding
	 * of the two strings using the StringEncoder this Comparator was created with.
	 *
